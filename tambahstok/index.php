		...
		<div class="row">
			<div class="col-sm-8">
				<form class="d-flex" method="POST" action="simpan.php">
					<input list="kode_produk" id="kp" name="kp" autocomplete="off" required placeholder="Kode Produk"
					...
					<datalist id="kode_produk">
						...
						while ($dt = mysqli_fetch_array($resp)) {
							?>
							<option value="<?= $dt['kode_produk'] ?>"><?= $dt['nama_produk'] ?> | <?= $dt['harga'] ?>
							</option>
							<?php
						}
						?>
					...
					<tr>
						...
						<td align="right">
							<a href="" class="btn btn-success btn-sm" data-bs-toggle="modal"
								data-bs-target="#modaledit<?= $data['id_produk'] ?>">Edit</a>
							...
							<div class="row">
								<div class="col-4 text-start py-3">
									...
									<button type="button" class="btn btn-primary" data-bs-toggle="modal"
										data-bs-target="#myModal">[+] Data Produk</button>
								</div>
