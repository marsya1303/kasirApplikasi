		...
		<div class="row">
				...
				<div class="row pb-2">
					...
					<div class="col-sm-4">
						...
						if (isset($_SESSION['id_pelanggan'])) {
							...
							<button class="btn btn-danger" type="submit" name="batal_pelanggan">Batal Pelanggan</button>
						</form>
							<?php
						} else {
							?>
			...
			<div class="col-md-4">
				...
				if (isset($_SESSION['bayar'])) {
					...
					<div class="p-2 rounded text-center my-0">
						<iframe name="cetak-nota" width="100%" height="200px"></iframe>
					</div>
...
<?php
if (isset($_POST['batal_pelanggan'])){
